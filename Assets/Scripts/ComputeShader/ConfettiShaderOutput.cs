...
[AddComponentMenu("ConfettiShaderOutput")]
public class ConfettiShaderOutput : MonoBehaviour
{
    ...
    /// </summary>
    public const int VertCount = 4 * 4 * 4 * 4 * 1;
    ...
    public void Dispatch()
    {
        ...
        computeShader.Dispatch(CSKernel, 4, 4, 1);
    }
